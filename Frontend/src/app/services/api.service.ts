...
export class ApiService {
  ...
  registerUser(name: any, email: any, password: any) {
    ...
    return this.http.post('http://localhost:5400/user/register', body);
  }

  // login(Email: any, Password: any) {
  //   const body = { Email, Password };
  //   return this.http.post('http://localhost:5400/user/login', body).subscribe(
  //     (response: any) => {
  ...
  login(email:any,password:any){
    ...
    return this.http.post('http://localhost:5400/user/login', body);
  }
  ...
  getDetails(InstaId: any) {
    return this.http.get(
      `http://localhost:5000/social/getdetails/${InstaId}`,
      this.appendToken()
    );
  }
  getAllUsers() {
    return this.http.get(
      'http://localhost:5000/social/getallusers',
      this.appendToken()
    );
  }
  viewSuggestion(suggestionId: any) {
    return this.http.get(
      `http://localhost:5000/social/viewSuggestion/${suggestionId}`,
      this.appendToken()
    );
  }
  ...
  followUser(personalId: any, followId: any) {
    ...
    return this.http.post(
      'http://localhost:5000/social/updatefollower/' + personalId,
      body,
      this.appendToken()
    );
  }
  addComments(filename: any, from_id: any, to_id: any, comment: any) {
    ...
    console.log(body);
    return this.http.post(
      'http://localhost:5000/social/uploadcomment',
      body,
      this.appendToken()
    );
  }
  ...
  readComments(filename: any) {
    return this.http.get(
      `http://localhost:5000/social/readcomments/${filename}`,
      this.appendToken()
    );
  }
  ...
  unFollow(userId: any, followId: any) {
    ...
    return this.http.put(
      'http://localhost:5000/social/unfollow/' + userId,
      body,
      this.appendToken()
    );
  }
  ...
  startMessage(person1: any, person2: any) {
    ...
    return this.http.post(
      'http://localhost:5000/social/startinbox',
      body,
      this.appendToken()
    );
  }
  ...
  outGoing(person1: any, person2: any) {
    ...
    return this.http.post(
      'http://localhost:5000/social/outgoing/' + person1,
      body,
      this.appendToken()
    );
  }
  ...
  inComming(person1: any, person2: any) {
    ...
    return this.http.post(
      'http://localhost:5000/social/incomming/' + person2,
      body,
      this.appendToken()
    );
  }
  ...
  findChats(person1: any, person2: any) {
    return this.http.get(
      `http://localhost:5000/social/findchat/${person1}/${person2}`,
      this.appendToken()
    );
  }
  ...
  messagePerson1(person1: any, person2: any, message: any, user_id: any) {
    ...
    return this.http.post(
      `http://localhost:5000/social/messagefromperson1/${person1}/${person2}`,
      body,
      this.appendToken()
    );
  }
  ...
  messagePerson2(person1: any, person2: any, message: any, user_id: any) {
    ...
    return this.http.post(
      `http://localhost:5000/social/messagefromperson2/${person1}/${person2}`,
      body,
      this.appendToken()
    );
  }
  ...
  likes(filename: any, likeId: any) {
    ...
    return this.http.post(
      `http://localhost:5000/social/addlikes/${filename}`,
      body,
      this.appendToken()
    );
  }
  ...
  getLikes(filename: any) {
    return this.http.get(
      `http://localhost:5000/social/getlikes/${filename}`,
      this.appendToken()
    );
  }
  ...
  deletePost(userId: any, filename: any) {
    ...
    return this.http.put(
      `http://localhost:5000/social/deletepost/${userId}`,
      body,
      this.appendToken()
    );
  }
  ...
  editProfile(userId: any, editingDetails: any) {
    ...
    return this.http.post(
      `http://localhost:5000/social/updateprofile/${userId}`,
      body,
      this.appendToken()
    );
  }
  ...
  changePasswordFromProfile(userId: any, Password: any) {
    ...
    return this.http.post(
      `http://localhost:5000/social/changepasswordfromprofile/${userId}`,
      body,
      this.appendToken()
    );
  }
  ...
  deleteAccount(userId: any) {
    return this.http.delete(
      `http://localhost:5000/social/deleteaccount/${userId}`,
      this.appendToken()
    );
  }
  ...
  //   return this.http.post(
  //     `http://localhost:5400/post/posts/${userId}`,
  //     formData,
  //     this.appendToken()
  //   );
  // }

  uploadPost(formData: any, userId: any): Observable<any> {
    let data = formData;
    return this.http.post(
  ...
  uploadProfilePic(formData: any, userId: any) {
    return this.http.post(
      'http://localhost:5000/social/profilepic/' + userId,
      formData,
      this.appendToken()
    );
  }
  ...
  removePeopleWhoFollow(_id: any, followId: any) {
    ...
    return this.http.put(
      'http://localhost:5000/social/removepeoplewhofollow',
      body,
      this.appendToken()
    );
  }
  ...
  individualLikes(filename: any, likeId: any) {
    ...
    return this.http.post(
      'http://localhost:5000/social/addindividuallikes',
      body,
      this.appendToken()
    );
  }
  ...
  getIndividualLikes(likeId: any) {
    return this.http.get(
      `http://localhost:5000/social/individual/${likeId}`,
      this.appendToken()
    );
  }
